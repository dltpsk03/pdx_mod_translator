...
LANGUAGES = {
    "ko": {
        ...
        "validation_section_title": "재번역 도구",
        "validation_open_window_button": "재번역 도구 열기",
        ...
        # Comparison Review Window
        "comparison_review_subtitle": "고급 오류 감지를 통한 원본 및 번역 파일 비교",
        "comparison_review_file_pairs": "파일 쌍",
        "comparison_review_filters": "필터",
        "comparison_review_display_mode": "표시 모드:",
        "comparison_review_display_errors_only": "오류만 표시",
        "comparison_review_error_filters": "오류 유형 필터:",
        "comparison_review_error_code_block": "코드 블록 오류",
        "comparison_review_error_unclosed_quote": "닫히지 않은 따옴표",
        "comparison_review_error_newline": "줄바꿈 오류",
        "comparison_review_error_merged_line": "병합된 라인",
        "comparison_review_error_source_remnants": "원본 언어 잔존",
        "comparison_review_file_list": "파일 목록",
        "comparison_review_file_comparison": "파일 비교",
        "comparison_review_original_file": "원본 파일",
        "comparison_review_translated_file": "번역 파일 (편집 가능)",
        "comparison_review_select_file": "비교를 시작하려면 파일 쌍을 선택하세요",
        "comparison_review_file_pairs_found": "개의 파일 쌍 발견",
        "comparison_review_with_errors": "개에 오류 있음",
        "comparison_review_errors_found": "개의 오류 발견",
        "comparison_review_no_errors": "오류가 감지되지 않음",

        # Retranslation Tool (Validation Window replacement)
        "retranslation_window_title": "재번역 도구",
        "retranslation_window_description": "번역되지 않은 텍스트 세그먼트를 감지하고 재번역",
        "retranslation_file_list": "번역된 파일",
        "retranslation_scan_button": "미번역 텍스트 검색",
        "retranslation_untranslated_items": "미번역 항목",
        "retranslation_select_all": "모두 선택",
        "retranslation_deselect_all": "모두 해제",
        "retranslation_retranslate_button": "선택 항목 재번역",
        "retranslation_status_ready": "스캔 준비됨",
        "retranslation_no_output_folder": "출력 폴더가 설정되지 않음",
        "retranslation_scanning": "파일 스캐닝 중...",
        "retranslation_found_files": "{0}개의 번역된 파일 발견",
        "retranslation_scan_complete": "완료",
        "retranslation_found_untranslated": "{0}개의 미번역 항목 발견",
        "retranslation_no_untranslated": "미번역 항목을 찾을 수 없음",
        "retranslation_original": "원본",
        "retranslation_current": "현재",
        "retranslation_reason_identical": "원본과 동일",
        "retranslation_reason_english": "영어 텍스트 포함",
        "retranslation_items_selected": "개 항목 선택됨",
        "retranslation_api_error": "API 키와 모델이 설정되어야 합니다",
    ...
    "en": {
        ...
        "retranslation_scan_complete": "Complete",
        ...
        "validation_section_title": "Retranslation Tool",
        "validation_open_window_button": "Open Retranslation Tool",
      ...
      "zh_CN": {
        ...
        "retranslation_scan_complete": "完成",
        ...
        "validation_section_title": "重新翻译工具",
        "validation_open_window_button": "打开重新翻译工具",
